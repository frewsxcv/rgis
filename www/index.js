import init, { run, get_widget_rect, get_all_widget_rects, get_rendered_layer_count, get_active_fade_count, close_window, set_first_layer_fill_color } from "rgis-pkg/rgis.js";
...
async function main() {
    ...
    window.get_active_fade_count = get_active_fade_count;
